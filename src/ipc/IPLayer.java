...
public class IPLayer implements BaseLayer {
    ...
    public boolean Send(byte[] input, short length) {
        ...
        // if(IsCaching) ARP���̺� ĳ�̵Ǿ������� EthernetLayer send ȣ��
        // return this.GetUnderLayer(0).send(temp, length+20);

        // else ĳ�̵����� ������ ARP Layer send ȣ��
    ...
    public synchronized boolean Receive(byte[] input) {
        ...
        short packet_tot_len = (short) (((input[2] & 0xFF) << 8) + ((input[3]) & 0xFF)); //��Ŷ �� ����
         ...
         *
         *
         * //�� IP�ּҿ� ��ġ�ϴ��� Ȯ�� for (int i = 0; i < 4; i++) { //����ġ
         *  if (dst_ip_addr[i] !=
